        ...
        <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col justify-center px-12 py-8 text-white">
            ...
            <div className="mb-12">
              ...
              <p className="text-2xl font-light text-purple-100 dark:text-gray-300 mb-6">
            ...
            <div className="mb-12">
              <h2 className="text-3xl font-light leading-relaxed text-white/95 dark:text-gray-200 mb-4">
                Transform your wardrobe with intelligent style recommendations
              </h2>
              <p className="text-lg text-purple-200 dark:text-gray-400">
            ...
            <div className="space-y-8">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-1">AI Photo Analysis</h3>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-1">Style Evolution</h3>
                  <p className="text-purple-100 dark:text-gray-300">
